                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <?php foreach ($users as $user): ?>
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <form method="POST" action="users/change" style="display:inline;" onsubmit="return confirm('Are you sure you want to change the status of this user?');">
                                                ...
                                                <td class="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200">
                                                    ...
                                                    <form method="POST" action="users/remove" style="display:inline;" onsubmit="return confirm('Are you sure you want to remove this user?');">
